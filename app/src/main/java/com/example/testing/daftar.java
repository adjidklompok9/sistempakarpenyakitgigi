...
public class daftar extends AppCompatActivity {
    ...
    private static final String url = "https://kelompok15nieboss.000webhostapp.com/spkulitwajah/get_daftar_penyakit.php";
    private ListView lv;
                    ...
                    try {
                        if (response.getInt("status") == 0) {
                            ...
                            AdapterView.OnItemClickListener itemClickListener = (parent, container, position, id) -> {
                                ...
                                Intent intent = new Intent(daftar.this, detail.class);
                            ...
                            if (kosong) {
                                Toast.makeText(daftar.this, "Tidak ada data penyakit",
